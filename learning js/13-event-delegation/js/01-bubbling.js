/*
 * Всплытие событий
 * event.target - целевой (исходный) элемент => самый глуобоко вложенный  на котором зарждается событие
 * event.currentTarget - текущий элемент, на слушателе которого поймали событие ( на нем стоит addEventListener) => при всплытии изменяется
 */
